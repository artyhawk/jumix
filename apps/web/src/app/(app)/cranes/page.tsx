...
export default function CranesPage() {
  ...
  const setParam = (key: string, value: string | null) => {
    ...
    router.replace(qs ? `/cranes?${qs}` : '/cranes', { scroll: false })
  }
  ...
  return (
    <PageTransition>
      <PageHeader title="Краны" subtitle="Парк оборудования всех организаций" />
        ...
        <DataTable
          ...
          empty={
            search || approval || op || type ? (
              ...
              <EmptyState
                icon={IconCrane}
                title="Кранов пока нет"
                description="Краны появятся здесь после регистрации владельцами организаций."
              />
            )
          }
        />
